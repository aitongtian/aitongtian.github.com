...
function t(e, i, s) {
	...
	4 : [function(t, e) {
		function i() {
			"use strict";
			this.element = null,
			this.className = "mx4_imgs loading loading_img",
			this.barHeight = 1,
			this.barColor = "#fff"
		}
		i.prototype.create = function() {
			...
			container1.setAttribute("class","spinner-container container1");
			var container2 = document.createElement("div");
			container2.setAttribute("class","spinner-container container2");
			var container3 = document.createElement("div");
			container3.setAttribute("class","spinner-container container3");
			spinner.appendChild(container1);
			spinner.appendChild(container2);
			spinner.appendChild(container3);
			
			var c1_circle1 = document.createElement("div");
			var c1_circle2 = document.createElement("div");
			var c1_circle3 = document.createElement("div");
			var c1_circle4 = document.createElement("div");
			c1_circle1.setAttribute("class","circle1");
			c1_circle2.setAttribute("class","circle2");
			c1_circle3.setAttribute("class","circle3");
			c1_circle4.setAttribute("class","circle4");
			container1.appendChild(c1_circle1);
			container1.appendChild(c1_circle2);
			container1.appendChild(c1_circle3);
			container1.appendChild(c1_circle4);
			
			var c2_circle1 = document.createElement("div");
			var c2_circle2 = document.createElement("div");
			var c2_circle3 = document.createElement("div");
			var c2_circle4 = document.createElement("div");
			c2_circle1.setAttribute("class","circle1");
			c2_circle2.setAttribute("class","circle2");
			c2_circle3.setAttribute("class","circle3");
			c2_circle4.setAttribute("class","circle4");
			container2.appendChild(c2_circle1);
			container2.appendChild(c2_circle2);
			container2.appendChild(c2_circle3);
			container2.appendChild(c2_circle4);
			
			var c3_circle1 = document.createElement("div");
			var c3_circle2 = document.createElement("div");
			var c3_circle3 = document.createElement("div");
			var c3_circle4 = document.createElement("div");
			c3_circle1.setAttribute("class","circle1");
			c3_circle2.setAttribute("class","circle2");
			c3_circle3.setAttribute("class","circle3");
			c3_circle4.setAttribute("class","circle4");
			container3.appendChild(c3_circle1);
			container3.appendChild(c3_circle2);
			container3.appendChild(c3_circle3);
			container3.appendChild(c3_circle4);
			"use strict";
	...
	5 : [function(t, e) {
		...
		i.prototype.applyStyling = function() {
			...
			//this.element.style.background = "url(img/bg.jpg)",
			this.element.style.width = "100%",
			this.element.style.position = "absolute",
			this.element.style.fontSize = "18px",
			this.element.style.top = "50%",
			this.element.style.left = "0",
			this.element.style.marginTop = "-" + (35 + this.barHeight) + "px",
